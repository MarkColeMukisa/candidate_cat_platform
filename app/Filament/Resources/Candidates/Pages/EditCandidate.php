...
class EditCandidate extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        $data['knows_html_css_js'] = (bool)($assessment['knows_html_css_js'] ?? false);
        $data['knows_react_next'] = $assessment['knows_react_next'] ?? 'none';
        $data['can_build_crud_with_db'] = (bool)($assessment['can_build_crud_with_db'] ?? false);
        $data['can_auth_password_google'] = (bool)($assessment['can_auth_password_google'] ?? false);
        $data['knows_express_hono_or_laravel'] = $assessment['knows_express_hono_or_laravel'] ?? 'none';
        $data['knows_golang'] = (bool)($assessment['knows_golang'] ?? false);
